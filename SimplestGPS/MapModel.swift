...
open class MapDescriptor {
         ...
         longNW: Double, latheight: Double, longwidth: Double)
    {
        ...
        sm[State.notloaded]![State.loading] = { info in
            ...
            let blat0 = ((info as! NSDictionary)["lat0"] as! NSNumber).doubleValue
            let blat1 = ((info as! NSDictionary)["lat1"] as! NSNumber).doubleValue
            let blong0 = ((info as! NSDictionary)["long0"] as! NSNumber).doubleValue
            let blong1 = ((info as! NSDictionary)["long1"] as! NSNumber).doubleValue
            let screenh = ((info as! NSDictionary)["screenh"] as! NSNumber).doubleValue
